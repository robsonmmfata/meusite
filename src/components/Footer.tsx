      ...
      <div className="container mx-auto px-6">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-600">Robsonmmfata@gmail.com</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-portfolio-indigo mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                </svg>
                <span className="text-gray-600">+55 (19) 97155-6747(Whatsapp)</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 text-center">
          <p className="text-gray-600">
            © {currentYear} Robson Alex Todos Direitos reservado.
          </p>
        </div>
      </div>
    </footer>
