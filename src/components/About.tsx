        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h3 className="text-2xl font-serif font-bold text-portfolio-blue mb-4">
              Designer Gráfico & Desenvolvedor Full Stack Sênior.
            </h3>
            <p className="text-gray-600 mb-6">
              Sou freelancer como Full Stack developer Sênior e UI Designer. Desenvolvo interfaces modernas e de alta qualidade, concentrado em performance, animações, responsividade e SEO,Sistemas de Mvp,Pdv,Erp,E-commerce,Landing Pages E Muito Mais.
            </p>
            <p className="text-gray-600 mb-6">
